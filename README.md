...
若提示 **「已损坏，无法打开」**（下载后常见），不是应用坏了，是 macOS 对未签名应用的安全拦截。
...
2. 粘贴下面命令后回车：
   ...
   ```bash
   xattr -cr "/Applications/My Postman.app"
   ```
...
1. 不要直接双击
2. 右键 `My Postman.app` →「打开」→ 再点「打开」

> **说明：** 当前为未签名测试包。完成 Apple 开发者签名 + 公证后，用户可直接双击打开，无需以上步骤。
